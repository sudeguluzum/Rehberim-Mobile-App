...
public class aytMatematikActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "AytMatematikPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "AytMatematikCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayt_matematik);
