...
public class fransizcaActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "fransizcaPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "fransizcaCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fransizca);
