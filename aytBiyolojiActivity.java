...
public class aytBiyolojiActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "AytBiyolojiPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "AytBiyolojiCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayt_biyoloji);
