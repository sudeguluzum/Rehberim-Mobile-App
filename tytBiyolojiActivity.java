...
public class tytBiyolojiActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytBiyolojiPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytBiyolojiCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_biyoloji);
