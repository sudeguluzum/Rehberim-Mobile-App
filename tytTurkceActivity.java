...
public class tytTurkceActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytTurkcePrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytTurkceCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_turkce);
