...
public class tytDinKulturuActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytDinPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytDinCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_din_kulturu);
