...
public class aytFelsefeActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "AytFelsefePrefs";
    private static final String CHECKBOX_KEY_PREFIX = "AytFelsefeCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayt_felsefe);
