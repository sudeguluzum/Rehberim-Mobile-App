...
public class tytCografyaActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytCografyaPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytCografyaCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_cografya);
