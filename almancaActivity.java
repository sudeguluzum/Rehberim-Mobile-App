...
public class almancaActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "almancaPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "almancaCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.almanca);
