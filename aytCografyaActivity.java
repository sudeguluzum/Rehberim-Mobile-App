...
public class aytCografyaActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "AytCografyaPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "AytCografyaCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayt_cografya);
