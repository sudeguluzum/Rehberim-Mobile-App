...
public class tytFizikActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytFizikPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytFizikCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_fizik);
