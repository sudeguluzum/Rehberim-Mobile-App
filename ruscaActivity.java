...
public class ruscaActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "ruscaPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "ruscaCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.rusca);
