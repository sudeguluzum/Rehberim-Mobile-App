...
public class ingilizceActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "IngilizcePrefs";
    private static final String CHECKBOX_KEY_PREFIX = "IngilizceCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ingilizce);
