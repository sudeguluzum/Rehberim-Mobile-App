...
public class arapcaActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "arapcaPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "arapcaCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.arapca);
