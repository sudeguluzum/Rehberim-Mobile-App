...
public class aytEdebiyatActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "AytEdebiyatPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "AytEdebiyatCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayt_edebiyat);
