...
public class tytFelsefeActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytFelsefePrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytFelsefeCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_felsefe);
