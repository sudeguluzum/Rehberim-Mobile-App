...
public class tytTarihActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytTarihPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytTarihCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_tarih);
