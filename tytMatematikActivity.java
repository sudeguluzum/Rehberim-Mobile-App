...
public class tytMatematikActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytMatematikPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytMatematikCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_matematik);
