...
public class aytTarihActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "AytTarihPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "AytTarihCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayt_tarih);
