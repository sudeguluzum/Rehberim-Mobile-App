...
public class tytGeometriActivity extends AppCompatActivity {
    private static final String PREFS_NAME = "TytGeometriPrefs";
    private static final String CHECKBOX_KEY_PREFIX = "TytGeometriCheckBox";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tyt_geometri);
